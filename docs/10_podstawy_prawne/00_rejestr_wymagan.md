...
### B.11 Ochrona przeciwpożarowa

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-210 | Kategoria zagrożenia ludzi **ZL IV**; grupa wysokości **N** (niski) | WT §209 ust. 2 pkt 4, §8 pkt 1 [R3 P-01, D-02] | PAB | KR |
| W-211 | **Zwolnienie** z §212 (klasa odporności pożarowej) i §216 (klasy odporności ogniowej i NRO elementów) — dom jednorodzinny **≤ 3 kondygnacji nadziemnych**; brak wymagań R/REI dla konstrukcji; warunek: dokładnie 3 kondygnacje (W-034, W-064) | WT §213 pkt 1 lit. a (z zastrzeżeniem §217 ust. 2 i §271 ust. 8a — nie dotyczą) [R3 P-02…P-04; R5-100] | PAB, PT-BO | AUD-WT |
| W-212 | Strefę pożarową tworzy cały budynek z garażem (brak oddzieleń) — jej kubatura do W-190 | WT §226 ust. 1 [R7-M03] | PAB | AUD-WT |
| W-213 | Ściany zewnętrzne i dach **nierozprzestrzeniające ognia** (ETICS z klasyfikacją NRO, dach B_ROOF(t1)) — unika zwiększeń odległości i spełnia §272 ust. 2 | WT §271 ust. 2, §272 ust. 2 [R3 3.2 pkt 7] [ZAŁ] | PAB, PT-AR | KR |
| W-214 | Przejścia instalacji przez ściany zewnętrzne poniżej terenu **gazoszczelne** (przez płytę — dobra praktyka) | WT §234 ust. 4 [R3 P-13, 3.5 pkt 25 (weryf.)] | PT-IS, PT-IE, PT-AR | KR |
| W-215 | Izolacje cieplne i akustyczne instalacji wodnych, kanalizacyjnych i c.o. nierozprzestrzeniające ognia | WT §267 ust. 8 [R3 P-14] | PT-IS | KR |
| W-216 | Okładziny elewacyjne i lamele P2 mocowane mechanicznie (dobra praktyka; §225 dla budynków z §213 praktycznie bez treści) | WT §225 [R3 P-18] [ZAŁ] | PT-AR | KR |
| W-217 | Dane ppoż. w PZT, PAB, PT: droga pożarowa niewymagana (ZL IV, N); zaopatrzenie w wodę ≥ **10 dm³/s** (5 dm³/s w jednostkach do 2000 mieszkańców) — wskazać najbliższy hydrant i dojście od drogi publicznej | rozp. Dz.U. 2009 nr 124 poz. 1030 §3 ust. 2–3, §12 ust. 1; RPB §14 pkt 6, §15 ust. 2 pkt 7 i 10, §20 ust. 1 pkt 13, §23 pkt 10 [R2 Z07, Z18, Z21, A16, P11] | PZT, PAB, PT | DOK |
| W-218 | Uzgodnienie projektu z rzeczoznawcą ppoż. niewymagane (ZL IV, budynek N, PV ≤ 50 kW); dla PV > 6,5 kW obowiązki z W-194 | rozp. Dz.U. 2023 poz. 1563 §3 ust. 1 [R2 W13] | WN | DOK |
| W-219 | Klasy odporności ogniowej na rysunkach tylko dla elementów, które mają takie wymagania (w projekcie brak) | RPB §9 ust. 2 [R2 F20; R4-A09] | PAB, PT | AUD-RYS |

### B.12 Akustyka

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-230 | Poziom hałasu i drgań w pomieszczeniach ≤ wartości **PN-B-02151-2:2018-01**; izolacyjność przegród zewnętrznych i wewnętrznych ≥ **PN-B-02151-3:2015-10** (+Ap1:2016-02); przewody nie pogarszają izolacyjności (garaż–dom: W-113) | WT §326 ust. 1–3, zał. 1 lp. 64–66 (Dz.U. 2023 poz. 2442) [R3 H-07, H-08] [NZW wartości norm] | PT-AR, PT-IS | OBL-FIZ |
| W-231 | Analiza akustyczna z RPB §23 pkt 4a **niewymagana** (wolnostojący, 1 lokal); WT §326 ust. 4a–4b nie dotyczy | RPB §23 pkt 4a (Dz.U. 2023 poz. 2405); WT §326 ust. 4a–4b [R1-22; R2 P05; R3 H-09] | PT | DOK |
| W-232 | Instalacje bez nadmiernego hałasu i drgań; posadowienie PC i centrali antywibracyjne, połączenia elastyczne (hałas w środowisku: W-024) | WT §327 ust. 2–3 [R3 H-10; R6-74] | PT-IS | KR |

### B.13 Energia (EP, U, g, szczelność)

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-240 | **EP ≤ EP_max = 70 kWh/(m²·rok)** (EP_H+W) + ΔEP_C = **5·A_f,C/A_f** (tylko przy instalacji chłodzenia) + ΔEP_L = 0; spełnione łącznie z W-243…W-249 | WT §328 ust. 1, §329 ust. 1–2 [R3 E-01, E-02; R6-09, R6-10] | PT-IS | OBL-EP |
| W-241 | Metodologia: Dz.U. 2015 poz. 376 ze zm. (ost. 2023 poz. 697): w_el = **2,50**; PV (tylko autokonsumpcja) w = **0,00**; energia oddana do sieci nie obniża EP; Q_p,L nie wyznacza się; A_f bez garażu nieogrzewanego; dane klimatyczne stacji Poznań (BIP ministra) | metodologia zał. 1 pkt 3.1.3, tab. 1; pkt 5.2 [R6-01, R6-13…R6-15, R6-21] | PT-IS | OBL-EP |
| W-242 | EP liczyć z **deklarowanych danych producenta** (SCOP wg PN-EN 14825, COP c.w.u. wg PN-EN 16147, η_oc wg PN-EN 13141-7, rzeczywiste moce pomocnicze) — przy wartościach domyślnych EP ≈ 99 > 70, z danymi producenta ≈ 58; Q_W,nd ≈ **24,1 kWh/(m²·rok)** (V_Wi 1,40; k_R 0,90; 55/10 °C); q_int **6,8 W/m²** | metodologia tab. 2, 3, 6, 9, 12, 14, 20, 26, 27 [R6-16…R6-20, R6 3.3] — D-07 | PT-IS | OBL-EP |
| W-243 | U_C,max (t_i ≥ 16 °C) [W/(m²·K)]: ściany zewnętrzne **0,20**; dachy i stropodachy **0,15**; strop nad powietrzem zewnętrznym (wspornik P2) **0,15** [INT]; podłoga na gruncie **0,30**; strop nad nieogrzewanym / oddzielający od nieogrzewanego **0,25**; ściana ogrzewane–nieogrzewane (dom–garaż) **0,30**; przegrody zewnętrzne garażu nieogrzewanego — bez wymagań | WT zał. 2 pkt 1.1 [R3 E-04…E-08; R6-22 (weryf.)] | PT-AR, PT-IS | OBL-FIZ |
| W-244 | U_max stolarki: okna, drzwi balkonowe, przeszklenia stałe **0,9**; okna połaciowe (klapa dachowa) **1,1**; drzwi zewnętrzne i drzwi garaż–dom **1,3**; brama garażu nieogrzewanego — bez wymagań | WT zał. 2 pkt 1.2 [R3 E-09; R6-23] | PT-AR | OBL-FIZ |
| W-245 | Cele projektowe U (nie przepis): ściana **0,15**; stropodach **0,12**; podłoga/płyta **0,20**; okno **0,80**; drzwi **1,10**; ściana dom–garaż **0,25** | [R6 3.2] [ZAŁ] — sprzeczność S-3 | PT-AR, PT-IS | OBL-FIZ |
| W-246 | Izolacja obwodowa podłogi na gruncie w pomieszczeniach ogrzewanych R ≥ **2,0 m²·K/W** | WT zał. 2 pkt 1.4 [R3 E-10; R6-24] | PT-AR, PT-BO | OBL-FIZ |
| W-247 | Okna E, S, W: **g = f_C·g_n ≤ 0,35** (lato); zwolnione: orientacja N ± 45°, okna < 0,5 m², okna chronione elementem zacieniającym spełniającym pkt 2.1.1 (okap — wykazać obliczeniowo); f_C zewnętrznych żaluzji 0,10–0,35; g_n domyślne 0,5; **A0max nie obowiązuje** | WT §328 ust. 2, §329 ust. 4, zał. 2 pkt 2.1.1–2.1.4 [R3 E-03, E-11…E-13; R6-26] | PT-AR (zestawienie stolarki) | OBL-FIZ |
| W-248 | Brak kondensacji powierzchniowej: **f_Rsi ≥ f_Rsi,kryt** (dopuszczalnie **0,72**, φ_i = 50 %); mostki 3D (wsporniki, łączniki termoizolacyjne, attyki, okapy, rama boksu C) wg PN-EN ISO 10211; kondensacja międzywarstwowa wg PN-EN ISO 13788:2013-05 | WT §321, zał. 2 pkt 2.2.1–2.2.5, zał. 1 lp. 70–71 [R3 H-06; R6-27] | PT-AR | OBL-FIZ |
| W-249 | Szczelność przegród, złączy i przejść; okna klasa ≥ **3** (≤ 2,25 m³/(m·h) lub ≤ 9 m³/(m²·h) przy 100 Pa); **n50** zalecane < **1,5 h⁻¹**, cel ≤ **1,0 h⁻¹** [ZAŁ]; próba ciśnieniowa (PN-EN ISO 9972) | WT zał. 2 pkt 2.3.1–2.3.4 [R3 E-14…E-16; R6-28] | PT-AR | OBL-FIZ |
| W-250 | Obliczanie U: PN-EN ISO 6946:2017-10 (R_se 0,04; R_si 0,10/0,13/0,17 [NZW]; poprawki zał. F; pustki poziom 1 → ΔU'' = 0,01; łączniki ETICS zawsze; wynik 2 cyfry znaczące); grunt PN-EN ISO 13370:2017-09; okna PN-EN ISO 10077-1/-2:2017-10; ψ wsporników numerycznie lub z deklaracji łącznika (nie domyślne z ISO 14683) | WT zał. 2 pkt 1.1, zał. 1 lp. 69–73 [R3 E-18; R6-29…R6-32] | PT-AR, PT-IS | OBL-FIZ |
| W-251 | Charakterystyka energetyczna w PT: bilans mocy, właściwości cieplne przegród, sprawności instalacji, wykazanie EP ≤ EP_max (EP, EK, EU, U_oze, E_CO2); dane do świadectwa (centralny rejestr charakterystyki energetycznej) na odbiór | PB art. 34 ust. 3 pkt 3 lit. b, art. 57 ust. 1 pkt 6a; RPB §23 pkt 11 lit. a–d; UChEB art. 4 ust. 3 [R6-02…R6-07 (weryf.)] | PT-IS | DOK |

### B.14 Konstrukcja (Eurokody 1. generacji + NA)

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-260 | Eurokody **1. generacji** (wersje polskie z NA), kompletny zestaw; nie mieszać z 2. generacją | WT §204 ust. 4, zał. 1 poz. 49 z przypisami *) i **); PKN „Eurokody” (06.2026) [R5-01…R5-03] | PT-BO | KR |
| W-261 | Klasa **CC2/RC2, K_FI = 1,0**; projektowy okres użytkowania 50 lat (kat. 4) → klasa konstrukcji **S4**; oddziaływania wyjątkowe CC1 (PN-EN 1991-1-7): wieńce, ściągi, połączenia wsporników z zapleczem | PN-EN 1990 zał. B, tabl. 2.1; PN-EN 1991-1-7 zał. A [R5-12…R5-14] | PT-BO | OBL-KON |
| W-262 | STR/GEO: mniej korzystne z 6.10a/6.10b — γ_G,sup **1,35**, ξ **0,85** (ξ·γ_G = 1,15), γ_G,inf 1,00, γ_Q **1,50**; EQU (wsporniki P2, płyty): **1,10·G_dst + 1,5·Q_dst ≤ 0,90·G_stb**; ψ₀/ψ₁/ψ₂: kat. A 0,7/0,5/0,3; dach H 0/0/0; śnieg 0,5/0,2/0; wiatr 0,6/0,2/0 | PN-EN 1990 + A1 + NA:2010 p. 6.4.3.2, tabl. A1.1–A1.2 [R5-10, R5-11] [NZW treść NA] | PT-BO | OBL-KON |
| W-263 | Obciążenia użytkowe: stropy kat. A q_k **2,0 kN/m²**, Q_k **3,0 kN**; schody **4,0 kN/m² / 4,0 kN**; dachy kat. H **0,4 kN/m² / 1,0 kN** (nie łączyć ze śniegiem ani wiatrem); ścianki lekkie ≤ 2,0 kN/m: +0,8 kN/m²; ścianki silikatowe — obciążenie liniowe; żelbet 25 kN/m³. Taras na płycie D — **nie dotyczy** (brief v2) | PN-EN 1991-1-1 tabl. 6.1–6.2, 6.10, p. 6.3.1.2, zał. A [R5-20…R5-25, R5 3.3] [NZW wartości NA — przyjęto górne granice EN] | PT-BO | OBL-KON |
| W-264 | Śnieg: strefa **2**, s_k = **0,90 kN/m²**, C_e = 1,0, C_t = 1,0, μ₁ = 0,8 ⇒ s = **0,72 kN/m²**; zaspy przy attykach μ₂ = γ·h/s_k ∈ [0,8; 2,0], l_s = 2h ∈ [5; 15] m; przy uskokach brył (dachy P0 i garażu przy P1, dach P1 przy P2) μ_w = (b₁ + b₂)/(2h) ≤ γ·h/s_k, ∈ [0,8; 4,0], γ = 2 kN/m³; **sytuacja wyjątkowa B2** (zał. B) obowiązkowa: μ₁ = min{2h/s_k; 2b/l_s; 8} [NZW]; nawisów nie uwzględnia się (A < 300 m) | PN-EN 1991-1-3 + AC + Ap1 + NA:2010 p. 5.3.2, 5.3.6, 6.2, 6.3, zał. B [R5-30…R5-38 (weryf.)] | PT-BO | OBL-KON |
| W-265 | Wiatr: strefa **1**, v_b,0 = **22 m/s**, q_b = **0,30 kN/m²**; c_dir = c_season = 1,0; c_s·c_d = 1,0; teren II (sektory S): c_e = 2,3·(z/10)^0,24; teren III: c_e = 1,9·(z/10)^0,26; obwiednia **q_p(h ≤ 11 m) = 0,71 kN/m²**; c_pe z tabl. 7.1–7.2 normy [NZW] | PN-EN 1991-1-4 + NA:2010 tabl. NA.1, NA.3 [R5-40…R5-45, R5 3.5 (weryf.)] | PT-BO | OBL-KON |
| W-266 | Beton: γ_c = **1,4**, γ_s = **1,15**; XC1 (stropy, wieńce) C25/30 (min. C20/25), c_nom **25 mm**; XC2 (fundamenty) C25/30, c_nom **35 mm** (≥ 50 mm od gruntu na podbetonie); XC3 (osłonięte spody wysięgów) C30/37, c_nom **35 mm**; XC4 + XF1 (krawędzie płyt wysuniętych, attyki) **C30/37**, kruszywo F2, w/c ≤ 0,55, c_nom **40 mm**; Δc_dev = 10 mm; c_min,dur (S4): XC1 15, XC2/XC3 25, XC4 30 mm | PN-EN 1992-1-1 + NA p. 2.4.2.4, 4.4.1, tabl. 4.3N–4.4N, zał. E [R5-50…R5-52, R5 3.6] [NZW NA:2018] | PT-BO | OBL-KON |
| W-267 | Szerokość rys w_max: **0,4 mm** (X0, XC1), **0,3 mm** (pozostałe klasy) | PN-EN 1992-1-1 p. 7.3.1, tabl. 7.1N [R5-53] | PT-BO | OBL-KON |
| W-268 | Ugięcia (quasi-stała) ≤ **L/250**; przyrost po wykonaniu elementów wrażliwych ≤ L/500 [NZW]; **wsporniki: L = 2 × wysięg** ⇒ koniec ≤ wysięg/125, przyrost ≤ wysięg/250 (z pełzaniem, skurczem, obrotem zaplecza); l/d: K = 0,4 dla wspornika; krawędź płyty P0 nad przeszkleniem ≈ 12,2 m i rama boksu C — szczelina dylatacyjna nad stolarką | PN-EN 1992-1-1 p. 7.4.1–7.4.2, tabl. 7.4N [R5-56, R5 3.7] | PT-BO | OBL-KON |
| W-269 | Stal zbrojeniowa **B500SP**, klasa ciągliwości C, f_yk = 500 MPa, f_yd = 435 MPa (PN-H-93220:2018-02 + Ap1:2018-04) | PN-EN 1992-1-1 zał. C [R5-55 (weryf.)] | PT-BO | KR |
| W-270 | Mur nośny: silikat gr. 1, kat. I, klasa 20, zaprawa do cienkich spoin: K = **0,60**, f_k = **7,66 MPa**, γ_M = **1,7** (klasa wykonania A — wymagana) ⇒ f_d = **4,50 MPa** (klasa B: γ_M 2,0 → 3,83 MPa); filarki < 0,3 m²: f_d/η_A (η_A 2,00…1,00); ściany nośne ≥ 18 cm | PN-EN 1996-1-1+A1:2013-05 + NA:2014-03 + Ap2:2014-09, tabl. NA.1, NA.5 [R5-60…R5-63] | PT-BO | OBL-KON |
| W-271 | Stal konstrukcyjna (jeśli wystąpi): S355/S235, γ_M0 = γ_M1 = **1,0**, γ_M2 = 1,25; klasa wykonania EXC2 [NZW] wg PN-EN 1090-2+A1:2024-10; belki ≤ L/250, przemieszczenia poziome H/150 (jednokondygnacyjne), H/500 (wielokondygnacyjne) | PN-EN 1993-1-1 + NA:2010 p. 6.1, 7.2 [R5-70…R5-72 (weryf.)] | PT-BO | OBL-KON |
| W-272 | Łączniki termoizolacyjne wsporników z ETA/EAD; nośność i ψ/χ wg dokumentu producenta | [R5 3.6, N-9; R6 3.2] | PT-BO, PT-AR | OBL-KON |
| W-273 | Drgania: brak dokuczliwych drgań (WT §204 ust. 3); PN-B-02171:2017-06 jako wiedza techniczna — kryterium dla wsporników ustalić w PT [NZW] | WT §204 ust. 3 [R5-04 (weryf.)] | PT-BO | OBL-KON |
| W-274 | PT-BO zawiera schematy statyczne, założenia i obciążenia, podstawowe wyniki obliczeń, rozwiązania materiałowe; w razie potrzeby informację o pomiarach przemieszczeń (monitoring ugięć wsporników) | RPB §23 pkt 1; PB art. 34 ust. 3 pkt 3 lit. a [R2 P01; R5-05, R5-06] | PT-BO | DOK |
| W-275 | Sprawdzenie projektu ustawowo niewymagane; **rekomendacja: dobrowolne sprawdzenie PT-BO** (wsporniki, płyty wysunięte, rama boksu C) | PB art. 20 ust. 3 pkt 2 [R1-27; R5-07] | PT-BO | DOK |

### B.15 Geotechnika i posadowienie

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-280 | Kategoria geotechniczna **II** (3 kondygnacje, schemat statycznie niewyznaczalny, wsporniki); warunki gruntowe proste; kategorię ostatecznie ustala opinia i projektant | rozp. Dz.U. 2012 poz. 463 §4 ust. 1–5 [R1-39; R2 A-G; R5-81, R5-82 (weryf.)] [INT] | PAB, PT-BO | DOK |
| W-281 | **Opinia geotechniczna** (PAB) + **dokumentacja badań podłoża gruntowego** + **projekt geotechniczny** (§10 pkt 1–10) w PT-BO; dokumentacja geologiczno-inżynierska niewymagana | rozp. 2012/463 §7 ust. 1–3, §8–10; PB art. 34 ust. 3 pkt 2 lit. d; RPB §20 ust. 1 pkt 5, §23 pkt 2 [R1-40; R5-83] | PAB, PT-BO | DOK |
| W-282 | Parametry z badań polowych (CPT/DPL) lub laboratoryjnych — korelacje PN-81 niedopuszczalne w kat. II; propozycja ≥ **3 punkty** w obrysie do ≥ **6 m** poniżej poziomu posadowienia [NZW]; oznaczyć k_f dla rozsączania | rozp. 2012/463 §6 ust. 2–3 [R5-83, R5-86, R5 3.8] | PT-BO | DOK |
| W-283 | Nośność podłoża: **DA2*** (A1 + M1 + R2), γ_R;v = **1,4**, γ_R;h = **1,1**; stateczność ogólna DA3; osiadania s ≤ **50 mm**, Δ ≤ 10 mm, ω ≤ 0,003 rad [NZW typ budynku] | PN-EN 1997-1 + Ap2:2010, NA.2.6, NA.3.2, tabl. NA.3 [R5-84, R5-85] | PT-BO | OBL-KON |
| W-284 | Posadowienie: usunąć ziemię urodzajną 0,4 m; ławy zewnętrzne i stopy ≥ **1,0 m** poniżej projektowanego terenu (h_z = **0,8 m** — PN-B-03020:1981 strefa I, norma wycof., wiedza techniczna; ITB Z₅₀ ≈ 1,31 m); ławy wewnętrzne ≥ **0,5 m**; zasypki niewysadzinowe; wariant płyty — izolacja obwodowa wg PN-EN ISO 13793:2002 | PN-B-03020:1981 p. 2.2.2 (wycof.); stanowisko PKN o normach wycofanych [R5-90…R5-94, R5 3.8] [NZW mapa h_z] | PT-BO | OBL-KON |
| W-285 | Ochrona przed wodą gruntową (ZWG ≈ 3,8 m ppt — drenaż zbędny); izolacja przeciwwilgociowa elementów w gruncie; ochrona cokołu nad terenem i dachami | WT §316 ust. 1, §317 ust. 1–2 [R3 H-02, H-03] | PT-AR, PT-BO | KR |
| W-286 | Wariant posadowienia (płyta na XPS czy ławy) koordynować z uziomem (W-187) i izolacją obwodową (W-246) | [R7-G02, R7 N-6; R5 3.8] | PT-BO, PT-IE | KR |

### B.16 Rysunek i forma projektu

| ID | Wymaganie | Podstawa | Gdzie | Sprawdzenie |
|---|---|---|---|---|
| W-300 | Język polski, czytelna technika graficzna; postać **elektroniczna**: PDF, część rysunkowa **wektorowa** (raster tylko jako podkład mapy), plik ≤ **150 MB**; PZT, PAB i ZL w tej samej postaci; PT w osobnych plikach (bez wspólnej oprawy elektronicznej) | RPB §2, §2b ust. 1–3, §5 ust. 3–4, §5a, §15 ust. 1a [R2 F01…F13; R4-A01…A05] | wszystkie | AUD-RYS |
| W-301 | Nazwy plików (zał. 1 RPB): `PZT_PAB_ZL_rrrr.mm.dd.pdf`; `PT_1_AR_rrrr.mm.dd.pdf`, `PT_2_BO_…`, `PT_3_IS_…`, `PT_4_IE_…` | RPB §2b ust. 4, zał. 1 [R2 F08; R4-A04] | wszystkie | AUD-RYS |
| W-302 | Plik podpisuje każda osoba opracowująca: podpis kwalifikowany, osobisty albo zaufany; w metryce pole „podpis” puste lub „podpisano elektronicznie” | RPB §7 ust. 4a [R2 F12; R4-A15] | wszystkie | DOK |
| W-303 | Strona tytułowa: nazwa elementu; nazwa zamierzenia; adres i **kategoria obiektu I**; identyfikator działki; inwestor i jego adres; data; imię, nazwisko, specjalność, **nr uprawnień** i zakres opracowania każdego autora; przy tomach: nr tomu i liczba tomów | RPB §7 ust. 2, 6; zał. do PB [R1-24, R1-33; R2 T03, T08] | wszystkie | AUD-RYS |
| W-304 | Spis treści z numerami stron; numeracja stron odrębna dla elementu i tomu; w części rysunkowej numer rysunku (unikalny w elemencie); łączny spis treści nie obejmuje PT | RPB §6 ust. 1–3, §7 ust. 5, 7–8 [R2 T07, T09, T10; R4-A06] | wszystkie | AUD-RYS |
| W-305 | **Metryka** każdego rysunku: nazwa obiektu, tytuł, skala, numer rysunku, imię i nazwisko projektanta z nr uprawnień, data sporządzenia (podpis — tylko papier); sprawdzający „nie dotyczy (art. 20 ust. 3 pkt 2 PB)”; tabliczka szer. 180 mm w prawym dolnym rogu; nr `<część>-<branża>-<nr>`, data rrrr-mm-dd [ZAŁ] | RPB §10 ust. 1–2; PN-EN ISO 7200:2007 [R2 T11, T12; R4-A12, B08, B09, R4 3.1] | wszystkie rysunki | AUD-RYS |
| W-306 | Skale: PAB i PT nie mniejsze niż **1:100** (PAB 1:100; PT 1:50; elementy żelbetowe 1:20; detale 1:10–1:5); PZT nie mniejsza niż **1:500** (+ rysunek szczegółowy 1:200) | RPB §9 ust. 3, 5 [R2 F18, F19; R4-A10, A11, R4 3.4] | wszystkie rysunki | AUD-RYS |
| W-307 | PZT: wymiary obiektów, odległości od granic i wzajemne z dokładnością zapisu **0,01 m** (pełne metry — 1 miejsce po przecinku); obowiązek od 05.11.2026, stosujemy od razu | RPB §15 ust. 3 (Dz.U. 2026 poz. 597 §1 pkt 3 lit. b, §2 ust. 2, §3) [R1-18; R2 Z14; R4-A18] | PZT | AUD-RYS |
| W-308 | Oznaczenia wg PN z zał. 2 RPB lub objaśnione w **legendzie na każdym arkuszu** — obowiązkowo dla: silikatów, betonu komórkowego, paroizolacji, nasypu, symboli instalacji wewnętrznych wod-kan i c.o., symboli elektrycznych IEC 60617 | RPB §9 ust. 1, zał. 2 [R4-A07, A08, A20, I03, N01, O01] | wszystkie rysunki | AUD-RYS |
| W-309 | Wymiarowanie (PN-B-01029): cm na rysunkach arch.-bud., m na PZT, mm na rysunkach zbrojenia i stali; ograniczniki 45°; pierwszy ciąg ≈ 10 mm od obrysu, kolejne co 7 mm; otwory ułamkiem szer./(parapet) wys. albo symbolem z zestawieniem; łańcuchy sumują się do wymiaru całkowitego | PN-B-01029:2000 (treść wg źródeł wtórnych) [R4-F01…F13, R4 3.5, 3.14] [NZW] | rysunki | AUD-RYS |
| W-310 | Rzędne: arch.-bud. i konstrukcyjne w m z **3 miejscami** (±0,000; +3,150); PZT z **2 miejscami** (`0,00=101,65`, z objaśnieniem w legendzie); m n.p.m. w PL-EVRF2007-NH | PN-B-01025:2004 p. 3.5; PN-B-01027:2002 poz. 1.8 [R4-G01, G06, M06, R4 3.6] | rysunki | AUD-RYS |
| W-311 | Linie (ISO 128-2): szereg 0,13/0,18/0,25/0,35/0,5/0,7/1/1,4/2 mm, proporcje 1:2:4; grupa **0,5** (1:100), **0,7** (1:50 i detale); odstęp linii równoległych ≥ **0,7 mm**; PZT wg PN-B-01027: obrys 1,4; przewieszenie > 1,0 m linią punktową 0,7; nieprzekraczalna linia zabudowy 0,35 z trójkątami niezaczernionymi; granica działki 0,35 | PN-EN ISO 128-2:2023-05; PN-B-01027:2002 [R4-C01…C08, M02…M13, R4 3.2, 3.11] | rysunki | AUD-RYS |
| W-312 | Pismo: 1,8/2,5/3,5/5/7/10/14/20 mm; na PZT ≥ **2,5 mm**; font bezszeryfowy z pełnym zestawem polskich znaków | PN-EN ISO 3098-1:2015-06, -4, -5; PN-B-01027 [R4-D01…D07, R4 3.3] | rysunki | AUD-RYS |
| W-313 | Arkusze (ISO 5457): margines lewy **20 mm**, pozostałe 10 mm, ramka 0,7 mm; oprawa i składanie do A4. Formaty: szereg A0–A4 zalecany (ISO 5457 p. 3.2 — formatów wydłużonych „należy unikać”), **formaty niestandardowe dopuszczone decyzją Inwestora 25.09.2026 (brief § 10)** — z oznaczeniem formatu na marginesie; RPB § 2a wymaga jedynie oprawy projektu w postaci papierowej do formatu A4 (sprawdzone: t.j. Dz.U. 2022 poz. 1679, ELI, 25.09.2026) | PN-EN ISO 5457:2002; RPB §2a [R4-B01…B07] | rysunki | AUD-RYS |
| W-314 | Numeracja na rysunkach: kondygnacje **1, 2, 3** (parter = 1), pomieszczenia `1.01…`, `2.01…`, `3.01…` (objaśnić w legendzie; klucze modelu P0/„0.01” bez zmian); numer i nazwa podkreślone; kolejność zgodnie z ruchem wskazówek zegara od wejścia głównego; klatka schodowa ten sam numer końcowy | PN-B-01025:2004 p. 3.4; PN-EN ISO 4157-1/-2:2001 [R4-J01…J05, R4 3.9 (weryf.)] [INT] | rysunki | AUD-RYS |
| W-315 | Rysunki PAB: rzuty P0, P1, P2, rzut dachu; ≥ 2 przekroje z terenem i podłożem (przez schody; przez wspornik A i boks C); elewacje N, S, E, W z wyrobami wykończeniowymi i kolorystyką (RAL/NCS) | RPB §21 pkt 1 lit. a–c [R1-21; R2 A20…A24] | PAB | DOK |
| W-316 | Powierzchnie wg **PN-ISO 9836:2022-07** z modyfikacjami RPB: PU bez przegród wewnętrznych, schodów wewnętrznych i podestów (lokal wielopoziomowy), balkonów, tarasów, loggii; z szafami wbudowanymi, schowkami, garderobami; waga wysokości ≥ 2,20 m → 100 %, 1,40–2,20 m → 50 %, < 1,40 m → 0 %; pow. całkowita bez tarasów, balkonów, loggii; m² i m³ z **2 miejscami**; garaż i pomieszczenia techniczne osobno | RPB §12, §20 ust. 1 pkt 4 lit. a–b (tiret 5 wg Dz.U. 2023 poz. 2405) [R2 A04…A06; R4-P01…P07, R4 3.13] | PAB (opis) | AUD-WT |
| W-317 | Zestawienia generowane z modelu: pomieszczeń (nr, nazwa, pow., posadzka, kategoria wg PN-ISO 9836), stolarki (symbol, wymiary, U, g, otwieranie, osłona), stali zbrojeniowej (ISO 3766), powierzchni i kubatury | PN-EN ISO 3766:2006; PN-EN ISO 4157-1 [R4-K01…K04, L01…L04, R4 3.10] | PAB, PT | AUD-RYS |
...
Każdy tom: strona tytułowa (§7 ust. 2), spis treści, **oświadczenie projektanta PT** (art. 34 ust. 3d pkt 3; treść zgodna z art. 41 ust. 4a pkt 2 PB: „…zgodnie z przepisami, zasadami wiedzy technicznej, PZT, PAB i rozstrzygnięciami…”), część opisowa (§23), część rysunkowa (§24, ≥ 1:100). W każdym tomie: dane ppoż. stosownie do zakresu (§23 pkt 10); §23 pkt 5 — n/d; §23 pkt 6 — n/d (budynek mieszkalny, nie obiekt liniowy); **§23 pkt 12** (dodany Dz.U. 2026 poz. 597 § 1 pkt 6, od 19.05.2026) — wpis w każdym tomie: „nie dotyczy: PZT i PAB nie przewidują budowli ochronnej ani miejsca doraźnego schronienia (PAB § 20 ust. 1 pkt 14 — n/d)” (lista kontrolna PT_WSPOLNE, C2-09); §23 pkt 4a analiza akustyczna — n/d (W-231). Metryki arkuszy: projektant — dane albo [DO UZUPEŁNIENIA], sprawdzający — „nie dotyczy (art. 20 ust. 3 pkt 2 PB)” (W-305, W-320; C2-10).
...
- **PT-4 IE + BT** (`PT_4_WB_…` — symbol WB z zał. 1 RPB, bo tom obejmuje dwie specjalności: instalacyjną elektryczną, PB art. 15a ust. 22, i telekomunikacyjną, art. 15a ust. 18 — telekomunikacja przewodowa; współautor z uprawnieniami telekomunikacyjnymi na stronie tytułowej i w oświadczeniu, art. 34 ust. 3e; lista kontrolna PT_WB; wariant alternatywny — osobny tom `PT_5_BT_…`): §23 pkt 7 lit. g elektroenergetyczne, lit. h telekomunikacyjne (światłowód, W-196), lit. i piorunochronne (analiza ryzyka, W-191); §23 pkt 8 lit. b moce elektryczne; §23 pkt 11 lit. a bilans mocy; §24 pkt 4 lit. b rzuty P0–P2 i dachu, schemat jednokreskowy RG, zasilanie ZKP–RG, plan uziomu i połączeń wyrównawczych, schemat PV, strefy łazienek; obliczenia I_B/I_z, ΔU, Z_s, CRL.
