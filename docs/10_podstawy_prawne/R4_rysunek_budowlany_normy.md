...
3. **Metryka rysunku (§ 10).** Obowiązkowe pola:
   ...
   * podpis, ale tylko w postaci papierowej.
   ...
   Dane sprawdzającego trafiają do metryki tylko przy obowiązku sprawdzenia. Art. 20 ust. 3 pkt 2 PB (t.j. Dz.U. 2026 poz. 524)
...
| R4-B13 | Każdy rysunek określa swój cel w tytule lub tytule uzupełniającym (wg ISO 7200). Wymagana **legenda symboli** w polu tekstu (wg ISO 9431) albo odrębny rysunek-legenda z odwołaniem. Rysunek podaje **zamierzony format papieru**, a każdy widok **swoją skalę**. Rysunki opierają się na układzie współrzędnych z wyróżnionym punktem odniesienia terenu. | ISO/FDIS 7519:2024 (= ISO 7519:2025) 4.1.2–4.1.3 | https://cdn.standards.iteh.ai/samples/89718/545a1bb2c2b24493a8b92bce1389a54e/ISO-FDIS-7519.pdf | TAK-N | Norma bez aktualnej wersji PN (pkt 2.1). Stosujemy jako dobrą praktykę spójną z § 9 rozp. |
...
| R4-F15 | Wymagane w WT wymiary rozumie się **z uwzględnieniem wykończenia**, a szerokość drzwi jako **wymiar w świetle ościeżnicy**. | WT (t.j. Dz.U. 2022 poz. 1225 ze zm.) § 9 ust. 1, cytowany w prezentacji IARP | https://www.warsztatarchitekta.pl/images/materialy-warsztat/Zabicki_Prezentacja_powierzchnie_IARP.pdf | NIE (cytat) | **Status WT do potwierdzenia przez R3.** Silnik liczy wymiary „surowe” (otwory w murze) i „wykończone” (sprawdzenia WT, powierzchnie). |
...
| ID | Wymaganie / reguła | Podstawa | URL | pierwotne? | Uwagi |
|---|---|---|---|---|---|
| R4-K01 | ISO 7519 (2024 i 2025) ma rozdział 5.7.6 „Schedules and lists” (zestawienia i wykazy) oraz 5.7.3 „Designations”. Treści w podglądzie brak. | ISO/FDIS 7519 spis treści | URL R4-B13 | TAK-N (spis) | Szczegóły **NIEZWERYFIKOWANE**. |
...
| R4-M06 | **1.8 Opis budynku:** „0,00=267,50”, liczba kondygnacji nadziemnych w kółku (np. „IV+P”), nr porządkowy (Nr1) przy wielu budynkach. Litery 0,25, **min. 2,5 mm**. | poz. 1.8 | [AGH-Z] s. 9 | NIE | LAMELA: „±0,00=101,65” i „III” (3 kond. nadziemne, brief). |
| R4-M07 | **Linie zabudowy:** **obowiązująca:** ciągła 0,35 z **zaczernionymi trójkątami równobocznymi o boku 2 mm** (rytm „12·2·12”). **Nieprzekraczalna:** jak wyżej z **trójkątami niezaczernionymi**. Trójkąty są po stronie terenu zabudowy. | poz. 2.1–2.2 | [AGH-Z] s. 10 | NIE | MPZP LAMELI: nieprzekraczalna 6,0 m od 1KDD, więc niezaczernione. Liczby rytmu w mm (interpretacja). |
...
* **Kolizja:** schemat modelu stosuje „0.01” (P0 = parter). PN-B-01025 3.4 i ISO 4157-1 7.2 (wtórnie i pierwotnie) każą
...
* **Rekomendacja:** ID w modelu bez zmian (P0/P1/P2, „0.01” jako klucz wewnętrzny). Na rysunkach drukujemy
  **numer kondygnacji = 1, 2, 3** i **numer pomieszczenia = `<kond>.<nn>`**: parter 1.01–1.xx, I piętro 2.01…, II piętro 3.01….
  ...
  z ISO 4157-2 4.4.3, który dotyczy numerów 4-cyfrowych.
