...
2. **ISTOTNA KOREKTA BRIEFU — śnieg:** Poznań i cały powiat poznański leżą w **strefie 2**, nie w strefie 1:
   **s_k = 0,9 kN/m²**, a nie 0,7 kN/m². Sprawdzono to na poligonach mapy NA:2010 (Dlubal Geo-Zone, 12 miejscowości; granica strefy 1
   przebiega ponad 60 km na zachód od Poznania). Potwierdzają to też publikacja w „Inżynierze Budownictwa” (2019) i poradnik Xella.
...
4. **Wiatr:** strefa 1 (potwierdzona na mapie NA): v_b,0 = 22 m/s, q_b = 0,30 kN/m². Dla h ≈ 10,5 m:
   q_p = 0,58 kN/m² przy terenie kategorii III i ok. 0,71 kN/m² przy kategorii II. Od południa działka graniczy z terenem rolnym,
   dlatego proponujemy obwiednię **q_p = 0,71 kN/m²**.
...
| R5-04 | § 204 ust. 3 WT: w konstrukcji nie mogą wystąpić rysy ani lokalne uszkodzenia, odkształcenia lub przemieszczenia pogarszające przydatność, uszkadzające części niekonstrukcyjne i wykończenie, ani drgania dokuczliwe dla ludzi. Zał. 1 poz. 48 powołuje **PN-B-02171:2017-06** „Ocena wpływu drgań na ludzi w budynkach”. | WT § 204 ust. 3; Zał. 1 poz. 48 | https://api.sejm.gov.pl/eli/acts/DU/2022/1225/text.pdf | P | Status WT — R3. |
...
| ID | Wymaganie / reguła | Podstawa | URL | P? | Uwagi |
|---|---|---|---|---|---|
| R5-30 | **Poznań i powiat poznański: strefa 2 → s_k = 0,9 kN/m²** (w strefie 2 wartość stała, niezależna od A). Wzory NA dla stref: 1: s_k = 0,007A − 1,4 ≥ 0,70; 2: 0,9; 3: 0,006A − 0,6 ≥ 1,2; 4: 1,6; 5: 0,93·exp(0,00134A) ≥ 2,0 kN/m². | PN-EN 1991-1-3:2005 + AC:2009 + Ap1:2010 + NA:2010, rys. NA.1 | https://loadzones.dlubal.com/file.aspx?kml=snow-pn-en-1991-1-3-l46-v2384.kml ; https://www.dlubal.com/pl/strefy-obciazenia-sniegiem-wiatrem-trzesieniem-ziemi/snieg-pn-en-1991-1-3.html ; https://inzynierbudownictwa.pl/obciazenie-sniegiem-wg-eurokodu-1-norma-pn-en-1991-1-3/ | W | Test punkt-w-wielokącie (skrypt `zones_check.py`): Poznań, Swarzędz, Komorniki, Suchy Las, Kórnik, Buk, Murowana Goślina, Stęszew, Luboń, Tarnowo Podgórne, Kostrzyn, Mosina — wszystkie w strefie 2. Na szerokości 52,40°N strefa 2 zaczyna się już na zachód od 15,5°E. Zgodnie z tym Xella (II strefa, 0,9) i O. Donajko (IB 2019): „Poznań … strefa 2”. Niektóre portale branżowe podają błędnie strefę 1. **Brief (0,7 kN/m²) do korekty.** |
...
| R5-33 | W Polsce wg NA **nie uwzględnia się** wyjątkowych opadów ani wyjątkowych zamieci (przypadek A, tylko sytuacja trwała i przejściowa). | PN-EN 1991-1-3 p. 3.2–3.3 + NA | http://pobierz.intersoft.pl/konkurs/EUROKODY/EUROKODY-Podstawy-projektowania-konstrukcji.pdf ; https://www.specbud.pl/uploads/reports/SPECBUD_KONEN2_Notka.pdf | W | Intersoft: „Na terenie Polski zgodnie z załącznikiem krajowym nie ma zastosowania przypadek wyjątkowych opadów śniegu”. |
...
| R5-35 | Zaspa przy attyce lub innej przeszkodzie: μ₂ = γ·h/s_k, **0,8 ≤ μ₂ ≤ 2,0**, l_s = 2h (5–15 m), rozkład trójkątny od μ₂ przy przeszkodzie do μ₁ w odległości l_s. | PN-EN 1991-1-3 p. 6.2 | — | — | Wartości podano z tekstu normy (pamięć); w źródle w tej sesji — **NIEZWERYFIKOWANE**. Obliczenie dla attyk LAMELA — sekcja 3.4. |
...
| R5-72 | Klasa wykonania konstrukcji stalowych wg PN-EN 1090-2: gdy nie określono inaczej, EXC2. | PN-EN 1090-2 p. 4.1.2 | — | — | NIEZWERYFIKOWANE (pamięć). Zalecenie: EXC2, konstrukcja cynkowana ogniowo. |
...
| ID | Wymaganie / reguła | Podstawa | URL | P? | Uwagi |
|---|---|---|---|---|---|
| R5-110 | Strefy klimatyczne (NA do PN-EN 12831:2006, podział jak w PN-82/B-02403): I: θ_e = −16 °C, θ_m,e = 7,7 °C; **II: −18 °C, 7,9 °C**; III: −20 °C, 7,6 °C; IV: −22 °C, 6,9 °C; V: −24 °C, 5,5 °C. **Poznań leży w strefie II.** | PN-EN 12831:2006, NA (Tabl. NA.1, rys. NA.1) | https://www.purmo.com/docs/Poradnik-Purmo-nowa-metoda-obliczania_12831_01_2012.pdf ; https://wentylacja.com.pl/news/kluczowe-zmiany-w-metodyce-obliczania-zapotrzebowania-na-cieplo-zawarte-w-pn-en-12831-33009.html | W | M. Strzeszewski, P. Wereszczyński, poradnik Purmo 2012, rys. 2.1 i tab. 2.1: Poznań na mapie w strefie II. Czy **PN-EN 12831-1:2017-08** (wersja i NA/NB) zmienia te wartości — NIEZWERYFIKOWANE (sklep PKN niedostępny, HTTP 503). |
...
PN-EN 1996-2:2010 + NA:2010; PN-EN 1997-1:2008 + A1:2014-05 + NA:2011; PN-EN 1997-2:2009; PN-EN 206+A2:2021-08 z PN-B-06265:2022-08;
PN-H-93220:2018-02 (B500SP); rozporządzenie Dz.U. 2012 poz. 463. **Stosować wyłącznie Eurokody 1. generacji; nie mieszać z 2. generacją** (R5-01…03).
...
* **Zaspy przy uskokach brył** (R5-34): μ_w = (b₁ + b₂)/(2h), ograniczone przez 2h/0,9 i przedział 0,8–4,0; l_s = 2h (5–15 m).
  ...
  Wartości h, b₁ i b₂ generować z `model/budynek.yaml`. Wynik: s = μ₂·0,9 kN/m², najwyżej 3,6 kN/m² przy ścianie.
* Nawisów śnieżnych (p. 6.3) nie uwzględniamy (A < 300 m, strefa 2). Wyjątkowych opadów i zamieci również (NA, przypadek A).

### 3.5 Wiatr (strefa 1: v_b,0 = 22 m/s, q_b = 0,30 kN/m², c_dir = c_season = 1,0, c_s·c_d = 1,0)
| z [m] | q_p, teren III [kN/m²] (c_e = 1,9·(z/10)^0,26; z_min = 5 m) | q_p, teren II [kN/m²] (c_r wg NA, I_v wg EN) |
|---|---|---|
| ≤ 5,0 | 0,48 | 0,60 |
| 7,0 | 0,52 | 0,65 |
| 10,0 | 0,57 | 0,70 |
...
**Proponowana obwiednia projektowa: q_p(z_e = h) = 0,72 kN/m²** (teren II dla wiatru z sektorów południowych, od strony terenu rolnego).
...
| Ławy lub płyta fundamentowa, ściany fundamentowe (zbrojone) | XC2 | **C25/30** | 25 | **35**; od strony gruntu ≥ 50 na podbetonie (NIEZWERYFIKOWANE, R5-52) | 0,3 |
...
* **Głębokość posadowienia:** usunąć ziemię urodzajną (0,4 m). Spód ław ścian zewnętrznych i stóp słupów wiaty **≥ 1,0 m**
  ...
  Wariant: płyta fundamentowa z izolacją obwodową. Wymaga osobnego uzasadnienia termicznego (PN-EN ISO 13793 — status NIEZWERYFIKOWANY).
...
konstrukcja:
  ...
  snieg: {strefa: 2, s_k: 0.90, C_e: 1.0, C_t: 1.0, mu1: 0.8, s_dach: 0.72, gamma_sniegu: 2.0, mu_w_max: 4.0, przypadek: A}
  wiatr: {strefa: 1, v_b0: 22.0, q_b: 0.30, c_dir: 1.0, kategoria_terenu_obwiednia: II, q_p_h: 0.72}
...
* **N-4: zamknięty wzór c_e(z) dla kategorii terenu II w PL NA.** Źródła wtórne są rozbieżne: VCmaster podaje 2,29·(z/10)^0,27,
  pamięć R5 — 2,3·(z/10)^0,24. W obwiedni przyjęto wartość z c_r(z) wg NA i I_v wg EN (0,71 kN/m² dla 10,5 m).
  Wybór kategorii terenu dla poszczególnych sektorów oraz c_dir z mapy NA — do rozstrzygnięcia w PT.
...
* **N-7: PN-EN 12831-1:2017-08.** Nieznane są wersja językowa, zawartość zał. NA/NB (tabela temperatur wg stacji?) i status PN-EN 12831:2006.
