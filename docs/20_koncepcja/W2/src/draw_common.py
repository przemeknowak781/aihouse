# -*- coding: utf-8 -*-
"""Wspolne funkcje rysunkowe (matplotlib) dla wariantu W2."""
import math
import matplotlib
matplotlib.use("Agg")
...
def core_poly(w):
    t = w["typ"]
    half = {"SZ1": 0.09, "SZL": 0.09, "SW18": 0.09, "SWG": 0.09, "SC12": 0.06, "DZ12": 0.06}[t]
