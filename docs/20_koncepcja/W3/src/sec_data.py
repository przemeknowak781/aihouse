...
("ins", -0.30, 8.90, ST3[1], P["dach_P2_warstwy"], "PIR spadkowy + membrana"),
...
SEC = {
    "A": dict(x=8.10, tytul="PRZEKRÓJ A-A (x = 8,10 — oś widoku: wejście → hol → jadalnia pod pustką → ogród)", el=COMMON + [
        ("zb", -1.20, 9.20, ST3[0], ST3[1], "ST3"), ("gl", -0.08, 0.08, 0.0, 2.75, "HS kw. 4"), ("zb", -1.30, 0.30, 2.75, 3.05, "okap E"), ("zb", -0.15, 0.15, 3.00, 3.45, "PD-1"),
        ("zb", -1.30, -0.30, 3.45, 3.65, "rama C"), ("zb", -1.30, -0.30, 5.15, 5.35, ""), ("gl", -0.08, 0.08, 3.65, 5.15, "boks C"),
        ("mur", -0.30, -0.15, 3.00, 3.65, ""), ("mur", 0.15, 0.30, 3.00, 3.65, ""), ("mur", -0.30, 0.30, 5.15, 5.70, ""),
    ...
    "B": dict(x=5.80, tytul="PRZEKRÓJ B-B (x = 5,80 — klatka schodowa pod latarnią SW1)", el=COMMON + [
        ("zb", -1.20, 5.70, ST3[0], ST3[1], "ST3"), ("zb", 8.60, 9.20, ST3[0], ST3[1], ""), ("gl", -0.08, 0.08, 0.0, 2.75, "kw. 3"), ("zb", -1.30, 0.30, 2.75, 3.05, "okap E"), ("zb", -0.15, 0.15, 3.00, 3.45, "PD-1"),
        ...
        ("mur", 8.60, 9.20, ST1[1], 7.20, "oś 4 (nadbudowa)"), ("gl", 8.85, 8.95, 7.20, 8.90, "okno ON3"), ("mur", 8.60, 9.20, 8.90, ST3[0], ""),
