...
| 10 | `budynek.yaml: energia.wentylacja.wywiewki_kanalizacyjne[] — rzędna z` | rzędna wylotu wywiewki kanalizacyjnej (element najwyższy dla wysokości zabudowy, upzp art. 2 pkt 30 lit. a) — przyjęto pokrycie + 0,50 m (wywiewka kanalizacyjna 1 (z = pokrycie + 0.50 m — ZAŁOŻENIE, brak rzędnej w modelu)); bez założenia H = 10,25 m | `wywiewki_kanalizacyjne: [[5.57, 6.2, 10.05]]  # [x, y, z]` | PZT-01 (tabela wskaźników), lamela.wskazniki |
