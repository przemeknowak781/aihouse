...
|---|---|---|---|---|---|
| Nośność podłoża (GEO, DA2*) | V_d = 13434,7 kN | R_d = 224314,1 kN | 6% | spełniony | PN-EN 1997-1 (6.1), NA.2.6 |
...
- Maks. docisk obliczeniowy z MES (obwiednia k_s, kombinacje STR/GEO): p_d,max = **364,0** kPa

| Warunek | Efekt | Nośność / limit | η | Stan | Podstawa |
|---|---|---|---|---|---|
| Docisk lokalny do podłoża (pasmo pod żebrem) | p_d,max = 364,0 kPa | q_Rd = 318,8 kPa | 114% | **NIESPEŁNIONY** | PN-EN 1997-1 6.5.2, zał. D |
...
- Maks. docisk charakterystyczny (SLS): p_k,max = **287,3** kPa
- Maks. osiadanie sprężyste (SLS, k_s nominalne): w_k,max = **43,9** mm

| Warunek | Efekt | Nośność / limit | η | Stan | Podstawa |
|---|---|---|---|---|---|
| Osiadanie (PN-EN 1997-1 zał. H: s ≤ 50 mm dla fundamentów bezpośrednich) | w_k = 43,9 mm | s_dop = 50,0 mm | 88% | spełniony | PN-EN 1997-1 zał. H |
...
|---|---:|---:|---:|
| dol_x | 577.2 | 2894 | 711 |
| dol_y | 838.2 | 5243 | 942 |
| gora_x | -2046.5 | 9866 | 1387 |
| gora_y | -1251.4 | 6987 | 2003 |

Elementy z μ > μ_lim — przekrój podwójnie zbrojony: 16 z 2865 (A_s2,max = 1829 mm²/m; A_s2 = ΔM/(σ_s2·(d − a₂)), ΔM = M_Ed − μ_lim·b·d²·η·f_cd, σ_s2 = min(f_yd; E_s·ε_cu3·(1 − a₂/x_lim)); A_s2 dodane do wymagania warstwy przeciwnej, A_s1 = A_s,lim + A_s2·σ_s2/f_yd).
