...
| D-11 | Ściana dom–garaż (SWG) na płycie fundamentowej | 1:10 | WZ-09a | 16/16 | 0 | 0 | ! | ✓ | ✓ | ! |
| D-14 | Próg drzwi DZ2 garażu — odwodnienie liniowe i uszczelnienie | 1:10 | — | 9/9 | 0 | 0 | ✓ | ✓ | ✓ | ✓ |
...
* **D-09** — 8/8 warstw zgodnych; 4 linie: H — WZ-04: odprowadzenie wody z krawędzi płyty (rynna / okapnik / rzygacz → rura spustowa) — nieokreślone w modelu…; S — ciągłość zachowana; P — ciągłość zachowana; I — obrys izolacji: 2 części (w tym warstwy dodatkowe, np. izolacja podłogi)
...
* **D-11** — 16/16 warstw zgodnych; 4 linie: H — linia na rysunku — 2 odcinki (przerwa?); S — ciągłość zachowana; P — ciągłość zachowana; I — WZ-09a: przerwana: DESKA_DEB → JASTRYCH → TYNK_GIPS → ZB_C25 → TYNK_CW (płyta ciągła do strefy nieogrzewanej —…; obrys izolacji: 4 części (w tym warstwy dodatkowe, np. izolacja podłogi)
* **D-14** — 9/9 warstw zgodnych; 4 linie: H — ciągłość zachowana; S — ciągłość zachowana; P — brak w detalu; I — ciągłość zachowana
