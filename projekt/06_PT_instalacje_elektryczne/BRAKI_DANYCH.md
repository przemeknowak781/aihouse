...
|---:|:---|:---|:---|:---|
| 1 | PV — rozmieszczenie modułów | w polu użytkowym dachu D1 zmieszczono 6 z 15 modułów (odsunięcia od krawędzi, otworów, czerpni/wyrzutni) | energia.pv.pole: [[x, y], …] (jawne pole montażu) lub zmiana liczby modułów | PT-IE-10 |
