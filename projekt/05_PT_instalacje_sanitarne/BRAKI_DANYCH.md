...
|---:|:---|:---|:---|:---|
| 1 | Trasy przewodów (woda, kanalizacja, c.o., wentylacja) | model nie zawiera przebiegów przewodów — trasy wyznaczono algorytmicznie (ortogonalnie, przy ścianach, z pionów/rozdzielaczy do przyborów) | instalacje.trasy: [{medium: Wz\|Wc\|Cyrk\|Ks\|Z\|P\|SUP\|ETA, kond, linia: [[x, y], …], dn, z}] | PT-IS-01, PT-IS-02, PT-IS-03, PT-IS-04, PT-IS-05 |
