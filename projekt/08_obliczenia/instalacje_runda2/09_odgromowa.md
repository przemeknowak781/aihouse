...
Obiekt: Dom LAMELA. PN-EN 62305-2 (WT: 2008; aktualna PN-EN IEC 62305-2:2025-09). Wynik wstępny — [NZW].
...
* Wysokość budynku nad terenem (najwyższa attyka), części: 4: H = **10,23** m — _model_
* Powierzchnia zbierania wyładowań bezpośrednich: A_D = pole(∪ bufor(obrys_i; 3H_i)) = **4281** m² — _PN-EN 62305-2 zał. A (A.2)_
* Liczba wyładowań w obiekt: N_D = N_G·A_D·C_D·10⁻⁶ = 1,8·4281·1,0·10⁻⁶ = **0,0077** 1/rok — _W-186: PN-86/E-05003/01 wg SEP (na północ od 51°30′) [niezweryfikowane]_
...
|:---|:---|---:|---:|---:|---:|---:|:---|
| brak ochrony | zwykłe | 7,71·10⁻⁷ | 7,71·10⁻⁷ | 1,80·10⁻⁶ | 1,80·10⁻⁶ | 5,14·10⁻⁶ | tak |
| brak ochrony | wysokie | 7,71·10⁻⁷ | 7,71·10⁻⁶ | 1,80·10⁻⁶ | 1,80·10⁻⁵ | 2,83·10⁻⁵ | **NIE** |
| SPD typ 1 (LPL III–IV) — projektowane (W-186) | zwykłe | 7,71·10⁻⁷ | 7,71·10⁻⁷ | 9,00·10⁻⁸ | 9,00·10⁻⁸ | 1,72·10⁻⁶ | tak |
| SPD typ 1 (LPL III–IV) — projektowane (W-186) | wysokie | 7,71·10⁻⁷ | 7,71·10⁻⁶ | 9,00·10⁻⁸ | 9,00·10⁻⁷ | 9,47·10⁻⁶ | tak |
| SPD T1 + gaśnica (r_p = 0,5) | zwykłe | 7,71·10⁻⁷ | 3,85·10⁻⁷ | 9,00·10⁻⁸ | 4,50·10⁻⁸ | 1,29·10⁻⁶ | tak |
| SPD T1 + gaśnica (r_p = 0,5) | wysokie | 7,71·10⁻⁷ | 3,85·10⁻⁶ | 9,00·10⁻⁸ | 4,50·10⁻⁷ | 5,16·10⁻⁶ | tak |
| LPS IV + SPD T1 | zwykłe | 1,54·10⁻⁷ | 1,54·10⁻⁷ | 9,00·10⁻⁸ | 9,00·10⁻⁸ | 4,88·10⁻⁷ | tak |
| LPS IV + SPD T1 | wysokie | 1,54·10⁻⁷ | 1,54·10⁻⁶ | 9,00·10⁻⁸ | 9,00·10⁻⁷ | 2,69·10⁻⁶ | tak |
| LPS III + SPD T1 | zwykłe | 7,71·10⁻⁸ | 7,71·10⁻⁸ | 9,00·10⁻⁸ | 9,00·10⁻⁸ | 3,34·10⁻⁷ | tak |
| LPS III + SPD T1 | wysokie | 7,71·10⁻⁸ | 7,71·10⁻⁷ | 9,00·10⁻⁸ | 9,00·10⁻⁷ | 1,84·10⁻⁶ | tak |

**Decyzja: LPS NIEWYMAGANY (R1 ≤ R_T przy SPD T1 dla obu klas obciążenia ogniowego).**

## 4. Uziom

* Uziom otokowy w gruncie: średnica zastępcza: D = √(4A/π) = √(4·251,4/π) = **17,89** m
* Rezystancja uziemienia (orientacyjnie, ρ = 400 Ω·m [ZAŁ]): R ≈ 2ρ/(3D) = 2·400/(3·17,89) = **14,9** Ω — _DEHN LPG [W]; pomiar po wykonaniu_

* Typ: otokowy w gruncie (fundament izolowany termicznie — PN-HD 60364-5-54 zał. C.2).
* Materiał: drut/płaskownik Cu 50 mm² lub StCu Ø10 mm lub StSt 30×3,5 mm, ≥ 0,5 m w gruncie, ≥ 1 m od ścian [ZAŁ].
...
* Liczba przewodów odprowadzających: IV — 3, III — 4 (co 20/15 m obwodu).
* Odstęp separacyjny (PV, instalacje na dachu): s = k_i·(k_c/k_m)·l = 0,04·(0,66/1)·10,23 ≈ **0,27 m** [NZW].
...
|:---|:---|---:|---:|:---|:---|
| W-191 | R1 (SPD T1, klasa „zwykłe”) ≤ R_T | 0,0000017 1/rok | ≤ 0,0000100 1/rok | SPEŁNIONY | W-191: PN-EN 62305-2 (ryzyko tolerowane R1) [niezweryfikowane] |
| W-191 | R1 (SPD T1, klasa „wysokie”) ≤ R_T | 0,0000095 1/rok | ≤ 0,0000100 1/rok | SPEŁNIONY | PN-EN 62305-2 [NZW] |
| W-191 | Odstęp separacyjny PV od zwodów LPS (jeśli LPS) — wymagany s | 0,27 m | — | informacyjnie | PN-EN 62305-3 p. 6.3 [NZW] |
