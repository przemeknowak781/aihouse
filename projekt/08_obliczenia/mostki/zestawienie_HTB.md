...
| WZ-07a | Krawędź stropu ST2Z nad powietrzem: ściana SZL na belce B3 + płyta PL-2 (łącznik) | +0,058 | **+0,182** | 0,60 / 0,15 | 0,837 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
...
| WZ-16a | Krawędź stropu ST2Z nad powietrzem: ściana SZ2 na belce B4 + płyta PL-2 (łącznik) | +0,057 | **+0,236** | 0,60 / 0,15 | 0,840 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-16b | Krawędź stropu ST2Z nad powietrzem: ściana SZ1 na belce B5 | −0,044 | **+0,123** | 0,60 / 0,15 | 0,880 ✓ | BEZMOSTKOWY | ✓ | ✓ | ✓ | ✓ | zachowana |
...
|---|---|---|---|---|
| WZ-01 | 45,90 | 19,94 | −25,96 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D1 19.94 |
| WZ-02 | 14,62 | 13,41 | −1,21 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D2 7.08, D3 6.33 |
| WZ-03 | 9,55 | 7,17 | −2,38 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D4 7.17 |
| WZ-04 | 21,82 | 22,47 | +0,65 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-E 19.97, PL-DA 2.50 |
| WZ-05 | 19,32 | 18,71 | −0,61 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-2 18.71 |
| WZ-06 | 25,05 | 24,30 | −0,75 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-3 24.30 |
...
| WZ-08 | 43,40 | 27,77 | −15,63 | obwód parteru pomieszczeń ogrzewanych bez progów |
...
| WZ-10 | 55,12 | 18,20 | −36,92 | ściana zewn. nad i pod stropem, bez płyt wspornikowych, dachów i garażu: ST1 13.47, ST2 4.73 |
...
| WZ-11T | 15,61 | 15,67 | +0,06 | szerokości otworów drzwiowych/HS parteru (parapet ≤ 5 cm) |
| WZ-12 | 49,50 | 40,05 | −9,45 | naroża wypukłe obrysu ogrzewanego × wys. kondygnacji: P0: 3 × 3.15 m; P1: 4 × 3.15 m; P2: 6 × 3.00 m |
| WZ-16a | 2,00 | 1,01 | +0,01 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 1.01 m |
| WZ-16b | 2,00 | 1,01 | +0,01 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 1.01 m |
| WZ-X1 | — (spoza sekcji) | 13,79 | — | krawędzie dachów D2, D3 pod ścianą SZ1: Σ 13.79 m |
| WZ-X2 | — (spoza sekcji) | 2,79 | — | krawędzie dachów D4 pod ścianą SZ1: Σ 2.79 m |
...
|---|---|---|---|---|---|---|
| WZ-01 | i–e | +0,174 | 19,94 | 1,00 | +3,47 | geometria |
| WZ-02 | i–e | +0,171 | 13,41 | 1,00 | +2,30 | geometria |
| WZ-03 | i–e | +0,195 | 7,17 | 1,00 | +1,40 | geometria |
| WZ-04 | i–e | +0,220 | 22,47 | 1,00 | +4,95 | geometria |
| WZ-05 | i–e | +0,226 | 18,71 | 1,00 | +4,23 | geometria |
| WZ-06 | i–e | +0,385 | 24,30 | 1,00 | +9,37 | geometria |
...
| WZ-16a | i–e | +0,236 | 1,01 | 1,00 | +0,24 | geometria |
| WZ-16b | i–e | +0,123 | 1,01 | 1,00 | +0,12 | geometria |
