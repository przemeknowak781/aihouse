...
| WZ-09a | Ściana dom–garaż (SWG) na płycie fundamentowej (POD-0 / POD-G) (ψ_iu = +0,301) | +0,301 | **+0,301** | 0,20 / 0,10 | 0,903 ✓ | ZŁY | ! | ✓ | ✓ | ✓ | uwaga — izolacja cieplna: przerwana: TYNK_GIPS → BET_KOM_600 → ZB_C25 → TYNK_CW (płyta ciągła do strefy nieogrzewanej — mostek konstrukcyjny) |
...
| WZ-16a | Krawędź stropu ST2Z nad powietrzem: ściana SZ2 na belce B4 + płyta PL-2 (łącznik) | +0,014 | **+0,194** | 0,60 / 0,15 | 0,854 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
...
| WZ-07a | 11,44 | 5,72 | +0,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 5.72 m |
| WZ-07b | 11,44 | 5,72 | +0,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu nad ścianą niższej kondygnacji — łącznie 5.72 m |
...
| WZ-07a | i–e | +0,152 | 5,72 | 1,00 | +0,87 | geometria |
| WZ-07b | i–e | −0,061 | 5,72 | 1,00 | −0,35 | geometria |
| WZ-08 | i–e | +0,100 | 27,77 | 1,00 | +2,78 | geometria |
| WZ-09a | i–u | +0,301 | 12,25 | 0,80 | +2,95 | geometria |
...
| WZ-16a | i–e | +0,194 | 1,01 | 1,00 | +0,20 | geometria |
