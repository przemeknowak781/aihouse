...
|---|---|---|---|---|---|---|---|---|---|---|---|
| WZ-01 | Attyka stropodachu bryły A (D1) | +0,063 | **+0,174** | 0,75 / 0,20 | 0,899 ✓ | DOBRY | ✓ | ✓ | ✓ | ✓ | zachowana |
...
| WZ-04 | Okap E (PL-E) i daszek wejścia — łącznik termoizolacyjny | +0,220 | **+0,220** | 0,30 / 0,15 | 0,903 ✓ | DO POPRAWY | ✓ | ! | ✓ | ✓ | uwaga — hydroizolacja / ochrona przed wodą: spadek płyty od budynku: nieokreślony w modelu (wymagany ≥ 1,5–2 %); odprowadzenie wody z krawędzi płyty (rynna / ok |
| WZ-05 | Krawędź ST2 (PL-2) — łącznik termoizolacyjny pod bryłą A | +0,218 | **+0,226** | 0,30 / 0,15 | 0,902 ✓ | DO POPRAWY | ✓ | ! | ✓ | ✓ | uwaga — hydroizolacja / ochrona przed wodą: spadek płyty od budynku: nieokreślony w modelu (wymagany ≥ 1,5–2 %); odprowadzenie wody z krawędzi płyty (rynna / ok |
| WZ-06 | Krawędź ST3 (PL-3) — łącznik termoizolacyjny przy attyce bryły A | +0,274 | **+0,385** | 0,75 / 0,20 | 0,825 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-07a | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — ściana SZL na krawęd | +0,058 | **+0,182** | 0,60 / 0,15 | 0,837 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-07b | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — krawędź nad ścianą S | −0,014 | **−0,061** | 0,60 / 0,15 | 0,952 ✓ | BEZMOSTKOWY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-08 | Cokół: ściana zewn. – płyta fundamentowa na XPS (część ogrzewana) | +0,058 | **+0,100** | 0,80 / 0,15 | 0,903 ✓ | DOBRY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-09a | Ściana dom–garaż (SWG) na płycie fundamentowej (POD-0 / POD-G) (ψ_iu = +0,616) | +0,616 | **+0,616** | 0,20 / 0,10 | 0,760 ✓ | ZŁY | ! | ✓ | ✓ | ✓ | uwaga — izolacja cieplna: przerwana: TYNK_GIPS → SIL18 → ZB_C25 → TYNK_CW (płyta ciągła do strefy nieogrzewanej — mostek konstrukcyjny) |
...
| WZ-16a | Belki wspornikowe B4/B5 i belka B3 w linii izolacji wspornika bryły A (ciągłość wełny pod ST2Z) | +0,057 | **+0,236** | 0,60 / 0,15 | 0,840 ✓ | DO POPRAWY | ✓ | ✓ | ✓ | ✓ | zachowana |
| WZ-16b | Belki wspornikowe B4/B5 i belka B3 w linii izolacji wspornika bryły A (ciągłość wełny pod ST2Z) | −0,044 | **+0,123** | 0,60 / 0,15 | 0,880 ✓ | BEZMOSTKOWY | ✓ | ✓ | ✓ | ✓ | zachowana |
...
|---|---|---|---|---|
| WZ-01 | 45,90 | 20,72 | −25,18 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D1 20.72 |
| WZ-02 | 14,62 | 14,62 | +0,01 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D2 7.50, D3 7.13 |
| WZ-03 | 9,55 | 7,99 | −1,56 | attyki nad pomieszczeniami ogrzewanymi, bez odcinków z płytą wspornikową i ze ścianą wyższą: D4 7.99 |
| WZ-04 | 21,82 | 22,08 | +0,26 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-E 19.59, PL-DA 2.50 |
| WZ-05 | 19,32 | 12,60 | −6,72 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-2 12.60 |
| WZ-06 | 25,05 | 24,93 | −0,12 | styk płyt z obudową (bez krawędzi stropu nad powietrzem): PL-3 24.93 |
| WZ-07a | 13,45 | 5,72 | −1,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 5.72 m |
| WZ-07b | 13,45 | 5,72 | −1,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu nad ścianą niższej kondygnacji — łącznie 5.72 m |
| WZ-08 | 43,40 | 27,27 | −16,13 | obwód parteru pomieszczeń ogrzewanych bez progów |
| WZ-09a | 24,50 | 12,25 | +0,00 | ściany S0-16, S0-17 (Σ 12.25 m) na płycie PF |
| WZ-09b | 24,50 | 6,38 | +0,00 | ściany S0-17 (Σ 6.38 m) |
| WZ-09c | 24,50 | 5,88 | +0,00 | ściany S0-16 (Σ 5.88 m) |
| WZ-10 | 55,12 | 24,42 | −30,70 | ściana zewn. nad i pod stropem, bez płyt wspornikowych, dachów i garażu: ST1 13.47, ST2 10.95 |
| WZ-11 | 89,90 | 89,90 | +0,00 | 2 × wysokość 24 otworów w ścianach zewn. części ogrzewanej |
| WZ-11N | 45,77 | 45,77 | +0,00 | szerokości otworów |
| WZ-11P | 29,62 | 29,62 | −0,00 | szerokości 15 okien z parapetem > 5 cm |
| WZ-11T | 16,15 | 16,17 | +0,02 | szerokości otworów drzwiowych/HS parteru (parapet ≤ 5 cm) |
| WZ-12 | 49,50 | 40,05 | −9,45 | naroża wypukłe obrysu ogrzewanego × wys. kondygnacji: P0: 3 × 3.15 m; P1: 4 × 3.15 m; P2: 6 × 3.00 m |
| WZ-16a | 2,00 | 1,00 | +0,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 1.00 m |
| WZ-16b | 2,00 | 1,00 | +0,00 | strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 1.00 m |
| WZ-X1 | — (spoza sekcji) | 14,63 | — | krawędzie dachów D2, D3 pod ścianą SZ1: Σ 14.63 m |
| WZ-X2 | — (spoza sekcji) | 3,03 | — | krawędzie dachów D4 pod ścianą SZ1: Σ 3.03 m |
...
|---|---|---|---|---|---|---|
| WZ-01 | i–e | +0,174 | 20,72 | 1,00 | +3,61 | geometria |
| WZ-02 | i–e | +0,171 | 14,62 | 1,00 | +2,51 | geometria |
| WZ-03 | i–e | +0,195 | 7,99 | 1,00 | +1,56 | geometria |
| WZ-04 | i–e | +0,220 | 22,08 | 1,00 | +4,87 | geometria |
| WZ-05 | i–e | +0,226 | 12,60 | 1,00 | +2,85 | geometria |
| WZ-06 | i–e | +0,385 | 24,93 | 1,00 | +9,61 | geometria |
| WZ-07a | i–e | +0,182 | 5,72 | 1,00 | +1,04 | geometria |
| WZ-07b | i–e | −0,061 | 5,72 | 1,00 | −0,35 | geometria |
| WZ-08 | i–e | +0,100 | 27,27 | 1,00 | +2,73 | geometria |
| WZ-09a | i–u | +0,616 | 12,25 | 0,80 | +6,03 | geometria |
...
| WZ-10 | i–e | −0,000 | 24,42 | 1,00 | −0,00 | geometria |
| WZ-11 | i–e | +0,005 | 89,90 | 1,00 | +0,48 | geometria |
| WZ-11N | i–e | +0,008 | 45,77 | 1,00 | +0,36 | geometria |
| WZ-11P | i–e | +0,006 | 29,62 | 1,00 | +0,18 | geometria |
| WZ-11T | i–e | +0,118 | 16,17 | 1,00 | +1,92 | geometria |
| WZ-12 | i–e | +0,066 | 40,05 | 1,00 | +2,62 | geometria |
| WZ-16a | i–e | +0,236 | 1,00 | 1,00 | +0,24 | geometria |
| WZ-16b | i–e | +0,123 | 1,00 | 1,00 | +0,12 | geometria |
| WZ-X1 | i–e | +0,022 | 14,63 | 1,00 | +0,33 | geometria |
| WZ-X2 | i–e | +0,022 | 3,03 | 1,00 | +0,07 | geometria |

| mostek punktowy | n [szt.] | χ [W/K] | n·χ [W/K] | liczba | źródło χ |
|---|---|---|---|---|---|
| WZ-13 — Konsole rusztu lamel (przekładka termiczna) | 50 | 0,010 | 0,500 | Σ długości linii lamel 25.05 m × 2 rygle / rozstaw konsol 1,0 m [ZAŁ] = 50 | [DANE PRZYKŁADOWE – FIKCYJNE] dane przykładowe z deklaracji typowej konsoli fasadowej z pr |
| WZ-14 — Konsole ramy boksu C i pasa D (punktowe, przekładka termiczna) | 10 | 0,010 | 0,100 | liczba z modelu (sekcja `wezly`) | fizyka.mostki.CHI_DOMYSLNE [NZW] |
