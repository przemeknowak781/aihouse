...
| WZ-07a | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — ściana SZL na krawędzi, belka B3, płyta PL-2 (łącznik) | 0,5616 | 0,182 | 0,058 | 0,182 | 13,82 | 0,837 | tak | 0,05 % |
| WZ-07b | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — krawędź nad ścianą SZ1 niższej kondygnacji | 0,5006 | −0,061 | −0,014 | 0,027 | 18,17 | 0,952 | tak | 0,01 % |
...
| WZ-07a | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — ściana SZL na krawędzi, belka B3, płyta PL-2 (łącznik) | 0,1821 | 6,7250 | 1,2249 |
| WZ-07b | Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — krawędź nad ścianą SZ1 niższej kondygnacji | −0,0607 | 6,7250 | −0,4079 |
...
| WZ-11 | Ościeża okien/drzwi — ciepły montaż (rama 5 cm w murze, 4 cm w izolacji, zakład izolacji 3 cm na ramę) | 0,0053 | 89,9000 | 0,4784 |
| WZ-11N | Nadproża — BEZ kaset osłon w ociepleniu (kasety w okapach / ramie C / szczelinie lamel / nadstawne) | 0,0078 | 45,7700 | 0,3573 |
| WZ-11P | Podokienniki — parapet zewn. z okapnikiem na profilu z XPS | 0,0059 | 29,6200 | 0,1756 |
| WZ-11T | Progi HS / drzwi zewn. na płycie P0 — profil progowy termoizolacyjny na podwalinie XPS/PUR-GF, odwodnienie liniowe | 0,1185 | 16,1500 | 1,9131 |
...
* płyta wspornikowa: ZB_C30, t = 0.2999999999999998 m, wierzch +0.00 m wzgl. wierzchu stropu, wysięg 1.1 m od lica ocieplenia
* łącznik: Łącznik termoizolacyjny 80 mm (moduł izolacyjny + pręty nierdzewne), λ_eq: λ_eq = 0.09 W/(m·K), d = 0.08 m — [DANE PRZYKŁADOWE – FIKCYJNE] λ_eq typowej deklaracji (ETA) łącznika 80 mm do płyt 20–22 cm; do zastąpienia wartością z ETA wybranego wyrobu (W-272)
* geometria z modelu: PL-2 przy stropie ST2, ściana dolna SZ1, górna SZ2; wysięg zastępczy A/L = 1.1 m; styk z obrysem 19.36 m; łącznik: dane przykładowe (ETA do uzupełnienia); wierzch wspornika zrównany z wierzchem płyty (konwencja audytu A2 K-1) [ZAŁ]
* długość z geometrii modelu [m]: 19,360
...
| siatka | komórek | Φ_całk [W/m] |
|---|---|---|
| 169 × 194 = 32786 komórek; Δx ∈ [1.65; 97.75] mm, Δy ∈ [1.65; 96.83] mm | 32786 | 23,7608 |
| 338 × 388 = 131144 komórek; Δx ∈ [0.825; 48.87] mm, Δy ∈ [0.825; 48.41] mm | 131144 | 23,7668 |

Zmiana strumienia przy podwojeniu liczby podziałów: **0,025 %** (kryterium ISO 10211 < 1 %: spełnione); zmiana L_2D (= zmiana ψ): 0,00016 W/(m·K) (kryterium ≤ max(1 % |ψ|; 0,001) = 0,00226: spełnione); bilans energii Σ Φ / (½ Σ|Φ|) = 5.2e-13 (kryterium < 10⁻⁴: spełnione).
...
## WZ-07a — Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — ściana SZL na krawędzi, belka B3, płyta PL-2 (łącznik)
...
* płyta wspornikowa: ZB_C30, t = 0.2999999999999998 m, wierzch +0.00 m wzgl. wierzchu stropu, wysięg 1.0 m od lica ocieplenia
* łącznik: Łącznik termoizolacyjny 80 mm (moduł izolacyjny + pręty nierdzewne), λ_eq: λ_eq = 0.09 W/(m·K), d = 0.08 m — [DANE PRZYKŁADOWE – FIKCYJNE] λ_eq typowej deklaracji (ETA) łącznika 80 mm do płyt 20–22 cm; do zastąpienia wartością z ETA wybranego wyrobu (W-272)
...
* długość z geometrii modelu [m]: 5,720
...
## WZ-07b — Strop P2 nad powietrzem zewnętrznym (ST2Z) — krawędzie wspornika bryły A — krawędź nad ścianą SZ1 niższej kondygnacji
...
* geometria z modelu: strop ST2Z (sufit SUF-ZEW); krawędzie typu nad ścianą niższej kondygnacji — łącznie 5.72 m
* długość z geometrii modelu [m]: 5,720
...
## WZ-16a — Belki wspornikowe B4/B5 i belka B3 w linii izolacji wspornika bryły A (ciągłość wełny pod ST2Z) — ściana SZ2 na krawędzi, belka B4, płyta PL-2 (łącznik)
...
* geometria z modelu: strop ST2Z (sufit SUF-ZEW); krawędzie typu ściana na krawędzi — łącznie 1.00 m
* długość z geometrii modelu [m]: 1,000
...
## WZ-16b — Belki wspornikowe B4/B5 i belka B3 w linii izolacji wspornika bryły A (ciągłość wełny pod ST2Z) — ściana SZ1 na krawędzi, belka B5
...
| siatka | komórek | Φ_całk [W/m] |
|---|---|---|
| 123 × 228 = 28044 komórek; Δx ∈ [1.65; 97.2] mm, Δy ∈ [0.5; 95.99] mm | 28044 | 20,5757 |
| 246 × 456 = 112176 komórek; Δx ∈ [0.825; 48.6] mm, Δy ∈ [0.25; 47.99] mm | 112176 | 20,5782 |

Zmiana strumienia przy podwojeniu liczby podziałów: **0,012 %** (kryterium ISO 10211 < 1 %: spełnione); zmiana L_2D (= zmiana ψ): 0,00007 W/(m·K) (kryterium ≤ max(1 % |ψ|; 0,001) = 0,00123: spełnione); bilans energii Σ Φ / (½ Σ|Φ|) = 3.5e-13 (kryterium < 10⁻⁴: spełnione).

**Współczynniki sprzężenia i ψ**

*Para i–e:* L_2D = **0,5415 W/(m·K)**
...
ψ_oi (wymiary wewnętrzne całkowite — system projektu, H_TB) = 0,5415 − 0,4187 = **0,123 W/(m·K)**; ψ_e (zewnętrzne) = 0,5415 − 0,5853 = −0,044 W/(m·K); ψ_i (wewnętrzne) = 0,5415 − 0,4187 = 0,123 W/(m·K)

**Temperatura powierzchni wewnętrznej i ryzyko pleśni** (R_si = 0,25 — PN-EN ISO 13788)

* θ_si,min = **15,46 °C** w punkcie (0,000; 0,600) m przy θ_i = 20,0 °C, θ_e = −18,0 °C
* f_Rsi = (θ_si,min − θ_e)/(θ_i − θ_e) = **0,880**; wymaganie f_Rsi ≥ 0,72 (WT zał. 2 pkt 2.2.1–2.2.5 (uproszczenie; φ_i = 50 %) (W-248)) → **SPEŁNIA**
* informacyjnie przy θ_e obliczeniowej i φ_i = 50 %: θ_si,kryt (φ_si = 80 %) = 12,6 °C (f = 0,806), punkt rosy 9,3 °C → θ_si,min ≥ θ_si,kryt (ocena miesięczna wg ISO 13788 — łagodniejsza; kryterium formalne: f_Rsi ≥ 0,72)
