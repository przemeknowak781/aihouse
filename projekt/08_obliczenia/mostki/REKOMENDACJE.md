...
| PL-2 | 21,3 | 0,64 | T1, T3 | rynna ukryta za blendą, spadek 2 % do czoła, RS DN70–DN90 do KD |
...
|---|---|---|---|---|---|---|---|
| D1 | przelew PA1 — attyka pn. nadbudowy (na d | 9,480 | 9,426 | 9,444 | 9,456…9,476 | ✗ | **9,476** |
| D1 | przelew PA2 — na dach D2 (pole zach., z  | 9,520 | 9,426 | 9,497 | 9,497…9,497 | ✗ | **9,497** |
| D1 | przelew PA3 — na dach D3 (pole wsch., z  | 9,520 | 9,426 | 9,527 | 9,527…9,527 | ✗ | **9,527** |
| D2 | przelew PA4 — attyka zach. | 6,460 | 6,296 | 6,329 | 6,329…6,346 | ✗ | **6,346** |
| D3 | przelew PA5 — attyka wsch. (awaryjnie na | 6,460 | 6,296 | 6,365 | 6,365…6,365 | ✗ | **6,365** |
| D4 | przelew PA6 — attyka wsch. (garaż) | 3,360 | 3,134 | 3,186 | 3,186…3,186 | ✗ | **3,186** |
| D4 | przelew PA7 — attyka wsch. (pas gosp.; > | 3,360 | 3,134 | 3,177 | 3,177…3,183 | ✗ | **3,183** |
...
|---|---|---|---|---|
| D1 | 9,776 | 9,605 | 0,17 m | ✓ |
| D2 | 6,660 | 6,441 | 0,22 m | ✓ |
| D3 | 6,660 | 6,440 | 0,22 m | ✓ |
