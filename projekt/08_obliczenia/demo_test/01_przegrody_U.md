...
| SD-D1 | Stropodach pełny, odwrócony spadek PIR | stropodach/dach | 10,27 | 0,009 | 0,084 | 0,15 | ✔ spełnia | 0,12 | ✔ spełnia |
...
| 3 | Paroizolacja bitumiczna | paroizolacja | 0,2 | 0,230 | 0,009 | jednorodna |
| 2 | Płyty PIR (izolacja spadkowa) | izolacja | 22,0 | 0,022 | 10,000 | jednorodna |
| 1 | Membrana EPDM 1,5 mm | hydroizolacja | 0,1 | 0,250 | 0,006 | jednorodna |

R_T = 0,10 + Σ R_j + 0,04 = 10,267 m²K/W; U₀ = 1/R_T = 0,0974 W/(m²K).

Poprawki (zał. F): ΔU_g = 0,0095, ΔU_f = 0,0000, ΔU_r = 0,0000 W/(m²K); U_c = 0,1069 W/(m²K).

Warstwa klinowa: U_śr = 0,0748 W/(m²K) (całkowanie numeryczne (zał. C, p. C.1), siatka 0,10 m, grubość rosnąca 2,0 % od wpustów); U = U_śr + ΣΔU = 0,0843 W/(m²K).
