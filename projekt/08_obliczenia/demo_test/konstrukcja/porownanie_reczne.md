...
| B1 | M_Ed,przęsło [kNm] | 54,24 | 49,72 | — | −8,3% | q_G = ΣR_G/L + b·h·25 = 45.28/3.82 + 1.50 = 13.35; q_Q = 8.67; q_S = 3.16 kN/m; q_d = 30.69 kN/m; M = q_d·l²/8, l = 3.76 m (rozkład równomierny zamiast rzeczywistego) |
| B1 | A_s,req [mm²] | 252,91 | 250,80 | — | −0,8% | b_eff = 0.85 m, d = 0.455 m, x = d − √(d² − 2M/(b_eff·f_cd)) = 6.0 mm, A_s = M/(f_yd·(d − x/2)) |
