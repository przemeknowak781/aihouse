...
| L3 | Oświetlenie zewnętrzne (wejście, elewacje, taras) | oswietlenie | 0,20 | 1 | 0,95 | 0,70 | 0,14 | — | L2 |
...
| D8 | Rekuperator (V ≈ 100 m³/h) | went | 0,03 | 1 | 0,95 | 1,00 | 0,03 | — | L3 |
| D9 | Falownik PV 3f (6,0 kW AC) | pv | 6,00 | 3 | 1,00 | 0,00 | gen. | — | L1L2L3 |
| D10 | Brama wjazdowa, furtka, wideodomofon (linia ogrodzenia) | napedy | 0,50 | 1 | 0,95 | 0,30 | 0,15 | — | L3 |
...
* Moc zainstalowana (bez generacji PV): P_i = ΣP = **42,9** kW
* Moc szczytowa bez zarządzania mocą: P_s = Σk_j·P = **23,9** kW — _k_j [ZAŁ]_
* Nastawa zarządzania mocą (granica: moc przyłączeniowa i prąd zabezpieczenia; zapas regulacji): P_lim = (1 − z)·min(P_przył; √3·U·I_zab·cos φ) = 0,95·min(27,0; √3·400·40·0,95/1000) = **25,01** kW — _z [ZAŁ]_
* Współczynnik ograniczenia odbiorników sterowanych — z mocy całkowitej: w_P = min(1; (P_lim − P_nst)/P_st) = (25,01 − 17,93)/6,00 = **1,000**
* Nastawa prądu fazowego DLM: I_nast = (1 − z)·I_zab = 0,95·40 = **38,0** A — _z [ZAŁ]_
* Współczynnik ograniczenia przyjęty (z mocy całkowitej i z prądu najbardziej obciążonej fazy): w = min(w_P; w_I), w_I: max I_Lk(w) = I_nast = **1,000**
* Moc szczytowa z DLM (odbiorniki sterowane ograniczone — ten sam współczynnik co w podziale na fazy): P_s,DLM = P_nst + w·P_st = 17,93 + 1,000·6,00 = **23,93** kW
* Prąd szczytowy: I_B = P_s/(√3·U·cos φ) = 23926/(√3·400·0,95) = **36,4** A
...
|:---|:---|---:|---:|:---|:---|
| W-192 | Moc szczytowa z DLM ≤ moc przyłączeniowa | 23,93 kW | ≤ 27,00 kW | SPEŁNIONY | W-192: R7 3.1 (zabezpieczenie przedlicznikowe 40 A) [zalozenie] |
| W-192 | Prąd szczytowy ≤ zabezpieczenie przedlicznikowe | 36,4 A | ≤ 40,0 A | SPEŁNIONY | R7-L09 |
| W-192 | Najbardziej obciążona faza: prąd ≤ zabezpieczenie przedlicznikowe | 36,8 A | ≤ 40,0 A | SPEŁNIONY |  |
| W-192 | Najbardziej obciążona faza: prąd ≤ nastawa DLM (95 % I_zab — zapas regulacji) | 36,8 A | ≤ 38,0 A | SPEŁNIONY | [ZAŁ] |
...
Warunków: 8; spełnionych: 8; niespełnionych: 0; informacyjnych: 0.
