...
Obiekt: Dom testowy pipeline'u 3D. Φ_HL: moduł fizyki/energii (PN-EN 12831). Dane urządzeń przykładowe [ZAŁ].
...
* Suma obciążeń cieplnych pomieszczeń (do wymiarowania podłogówki): ΣΦ_HL,i = **5,84** kW — _moduł fizyki/energii (PN-EN 12831)_
* Projektowe obciążenie cieplne budynku (do doboru źródła): Φ_HL,bud (bez strumieni między pomieszczeniami ogrzewanymi) = **5,71** kW — _PN-EN 12831-1 — wynik modułu energii_
* Dodatek na przygotowanie c.w.u.: Φ_W = 0,25 kW/os·N = 0,25·4 = **1,00** kW — _VDI 4645 [W]_
* Wymagana moc źródła przy θ_e (układ monowalentny): Φ_PC = Φ_HL + Φ_W = 5,71 + 1,00 = **6,71** kW

| Pomieszczenie | Φ_HL [W] |
|:---|---:|
| 0.01 Gabinet | 710 |
| 0.02 Hol ze schodami | 535 |
| 0.03 Salon | 1042 |
...
* Pomieszczenie projektowe: 1.02 Hol: q_des = Φ_HL/A_F = 593/9,54 = **62,2** W/m² — _PN-EN 1264-3 (bez łazienek; największa wymagana θ_V)_
* K_H dla T = 0,10 m, R_λ,B = 0,10, s_u = 0,038 m, λ_E = 1,00: K_H = B·a_B·a_T^m_T·a_u^m_u·a_D^m_D = **3,884** W/(m²·K) — _PN-EN 1264-2 zał. A [NZW tablice]_
* Nadwyżka temperatury czynnika: ∆θ_H = q/K_H = 62,2/3,884 = **16,01** K
* Temperatura zasilania wymagana (σ = 5 K): θ_V = θ_i + σ·e^(σ/∆θ_H)/(e^(σ/∆θ_H) − 1) = **38,6** °C — _definicja ∆θ_H (średnia logarytmiczna)_
* Projektowa temperatura zasilania: θ_V,des = min(θ_V; θ_V,max) = min(38,6; 35,0) = **35,0** °C — _W-153 (R6 3.4) — niedobór mocy w pomieszczeniu projektowym pokrywa dodatkowa powierzchnia grzewcza_
...
|:---|:---|:---|---:|---:|---:|---:|:---|---:|---:|---:|---:|---:|---:|---:|
| 0.01 | Gabinet | P0 | 710 | 14,7 | 48,5 | 24,7 | DESKA_DEB (drewno 15 mm) 0,10 | 10 | 13,54 | — | 5,00 | 134,8 | 2 | 161,6 |
...
|:---|---:|---:|---:|---:|---:|
| 0.01/1 | 10 | 80,8 | 67,4 | 10,6 | 9,1 |
| 0.01/2 | 10 | 80,8 | 67,4 | 10,6 | 9,1 |
| 0.02/1 | 25 | 52,2 | 148,2 | 19,0 | 5,9 |
| 0.03/1 | 10 | 75,9 | 65,8 | 10,1 | 8,6 |
| 0.03/2 | 10 | 75,9 | 65,8 | 10,1 | 8,6 |
| 0.03/3 | 10 | 75,9 | 65,8 | 10,1 | 8,6 |
| 0.04/1 | 20 | 82,4 | 119,4 | 20,2 | 9,3 |
| 1.01/1 | 10 | 59,0 | 55,2 | 6,9 | 6,7 |
...
* Wysokość podnoszenia pompy obiegowej (obieg z buforem szeregowym na powrocie): H = ∆p_pętli,max + ∆p_przew + ∆p_PC + 5 = 20,2 + 8,3 + 15 + 5 = **48,5** kPa — _rozdzielacz/zawory 5 kPa [ZAŁ]_
* Suma przepływów pętli podłogowych: Σṁ_H = **1192** kg/h

* Objętość wody w pętlach: V = Σπd²/4·L = **122,7** dm³
* Objętość stale otwarta (pętle bez siłowników): V_otw = u·V = 0,30·122,7 = **36,8** dm³ — _[ZAŁ]_
...
* Wymagana pojemność bufora: V_buf = max(V_def, V_run) − V_otw = **37,7** dm³
* Dobrano bufor szeregowy na powrocie: V = **40** dm³

## 5. Naczynia wzbiorcze

* Pojemność instalacji c.o.: V_c = V_pętli + V_bufora + V_PC + V_wężownicy + V_przewodów = **185,6** dm³
...
* Pojemność naczynia c.o.: V_n = (V_e + V_V)·(p_e + 1)/(p_e − p_0) = (3,11 + 3,00)·(2,50 + 1)/(2,50 − 0,51) = **10,7** dm³
...
|:---|:---|---:|---:|:---|:---|
| W-155 | Punkt biwalentny | −8,4 °C | ≤ −7,0 °C | SPEŁNIONY | VDI 4645 / praktyka [ZAŁ] |
| W-155 | Pokrycie mocy przy θ_e (układ monoenergetyczny): P_PC(θ_e) + P_grzałki ≥ Φ_HL + Φ_W | 9,30 kW | ≥ 6,71 kW | SPEŁNIONY | PN-EN 12831 / VDI 4645 [W] |
| W-155 | Udział grzałki w pokryciu Q_H | 0,001 | ≤ 0,050 | SPEŁNIONY | [ZAŁ] |
...
| W-153 | 0.01 Gabinet: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 48,5 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-153 | 0.01 Gabinet: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL | 734 W | ≥ 710 W | SPEŁNIONY | PN-EN 1264-3 — dodatkowa powierzchnia grzewcza (ściana) lub mniejsze R_λ,B; brak ≈ 0 W |
...
| W-153 | 0.02 Hol ze schodami: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 47,5 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-154 | Pętla 0.02/1: długość | 52,2 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 0.03 Salon: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 49,9 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-153 | 0.03 Salon: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL | 1046 W | ≥ 1042 W | SPEŁNIONY | PN-EN 1264-3 — dodatkowa powierzchnia grzewcza (ściana) lub mniejsze R_λ,B; brak ≈ 0 W |
...
| W-153 | 0.04 Kuchnia z jadalnią: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 49,1 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-154 | Pętla 0.04/1: długość | 82,4 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 1.01 Sypialnia: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 56,3 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-153 | 1.01 Sypialnia: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL | 556 W | ≥ 576 W | **NIESPEŁNIONY** | PN-EN 1264-3 — dodatkowa powierzchnia grzewcza (ściana) lub mniejsze R_λ,B; brak ≈ 20 W |
| W-154 | Pętla 1.01/1: długość | 59,0 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-154 | Pętla 1.01/2: długość | 59,0 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 1.02 Hol: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 62,2 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-153 | 1.02 Hol: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL | 518 W | ≥ 593 W | **NIESPEŁNIONY** | PN-EN 1264-3 — dodatkowa powierzchnia grzewcza (ściana) lub mniejsze R_λ,B; brak ≈ 75 W |
| W-154 | Pętla 1.02/1: długość | 51,5 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-154 | Pętla 1.02/2: długość | 51,5 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 1.03 Pokój: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 50,0 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-154 | Pętla 1.03/1: długość | 74,8 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-154 | Pętla 1.03/2: długość | 74,8 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-154 | Pętla 1.03/3: długość | 74,8 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 1.04 Garderoba: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 65,0 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-153 | 1.04 Garderoba: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL | 305 W | ≥ 365 W | **NIESPEŁNIONY** | PN-EN 1264-3 — łazienka: dogrzewanie grzejnikiem drabinkowym; brak ≈ 60 W |
| W-154 | Pętla 1.04/1: długość | 70,1 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-153 | 1.05 Sypialnia 2: gęstość strumienia ≤ q_G (θ_F ≤ 29 °C) | 39,1 W/m² | ≤ 100,0 W/m² | SPEŁNIONY | PN-EN 1264-2 |
| W-154 | Pętla 1.05/1: długość | 45,1 m | ≤ 100,0 m | SPEŁNIONY | PE-X 16×2 [W] |
| W-154 | Maks. strata ciśnienia pętli | 20,2 kPa | ≤ 25,0 kPa | SPEŁNIONY | [ZAŁ] |
...
Warunków: 43; spełnionych: 40; niespełnionych: 3; informacyjnych: 0.

Niespełnione:

* W-153 — 1.01 Sypialnia: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL: 556 W (wymaganie >= 576 W)
* W-153 — 1.02 Hol: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL: 518 W (wymaganie >= 593 W)
* W-153 — 1.04 Garderoba: moc podłogi przy θ_V,des (T = 10 cm) ≥ Φ_HL: 305 W (wymaganie >= 365 W)
